...
#End Region
	...
	Private _lastRestPlace As String = "Johto\Cities\NewBark\YourHousef2.dat"
	Private _lastRestPlacePosition As String = "1,0.1,3"
	Private _lastSavePlace As String = "Johto\Cities\NewBark\YourHousef2.dat"
	...
	Public Structure Temp
		...
		Public Shared BeforeBattleLevelFile As String = "Johto\Cities\NewBark\YourHousef2.dat"
					...
					If Items.Count = 17 AndAlso String.Equals(Hash, Encryption.DecryptString(Items.Last, StringObfuscation.Obfuscate(GameJoltSave.GameJoltID))) Then
							...
							For Each ItemDat As String In Data.SplitAtNewline()
								If Not String.IsNullOrWhiteSpace(ItemDat) Then
									...
									ElseIf ItemDat.StartsWith("Mail|") Then
										...
										Mails.Add(P3D.Items.MailItem.GetMailDataFromString(mailData))
									End If
								End If
							Next
						End If
						...
						For Each Line As String In Data.SplitAtNewline()
							If Not String.IsNullOrWhiteSpace(Line) AndAlso Line.Contains("|") Then
								...
								Select Case ID.ToLower()
									Case "name"
										Name = CType(If(IsGameJoltSave, GameJolt.API.username, Value), String)
									Case "position"
