Namespace GameJolt
    ...
    Public Class GTSSearchScreen
		...
		Private Sub DrawFilters()
			Core.SpriteBatch.DrawString(FontManager.MainFontBlack, "Area: " & Me.AreaFilter, New Vector2(280, 4), Color.White)
			Core.SpriteBatch.DrawString(FontManager.MainFontBlack, "Offer:", New Vector2(280, 26), Color.White)
			Core.SpriteBatch.DrawString(FontManager.MainFontBlack, "Request:", New Vector2(792, 26), Color.White)
				...
				Else
					...
					If Selected > -1 Then
						...
						If Not D.Pokemon.Item Is Nothing Then
							...
							Core.SpriteBatch.Draw(D.Pokemon.Item.Texture, New Rectangle(575, 478, 48, 48), Color.White)
						End If
						...
						Core.SpriteBatch.DrawString(FontManager.MainFontBlack, "Level: " & D.Pokemon.Level & Environment.NewLine & Environment.NewLine &
													 ...
													 "Item: " & ItemString, New Vector2(524, 360), Color.White)
						...
						Core.SpriteBatch.DrawString(FontManager.MainFontBlack, "Request:" & Environment.NewLine & Environment.NewLine &
													 ...
													 "Gender: " & D.RequestGender, New Vector2(824, 360), Color.White)
						...
						'To:
						Core.SpriteBatch.DrawString(FontManager.MainFontBlack, "To:", New Vector2(816, 320), Color.White)
						If SearchResults(Selected).SecurityArea = GTSDataItem.SecurityCode.Private Then
							...
							Core.SpriteBatch.DrawString(FontManager.MainFontBlack, ownEmblem.Username & " (" & ownEmblem.GameJoltID & ")", New Vector2(900, 320), Color.White)
						Else
							Core.SpriteBatch.DrawString(FontManager.MainFontBlack, "Global", New Vector2(864, 320), Color.White)
						End If
