Namespace GameJolt
    ...
    Public Class PhoneScreen
        ...
        Public Sub New(ByVal currentScreen As Screen, ByVal EntryMode As EntryModes, ByVal Data() As Object)
            Me.Identification = Identifications.PhoneScreen
            ...
            If Me.UserBanned = False Then
                ...
                End If
                If (ActionScript.IsRegistered("phone_card_GTS") = True Or GameController.IS_DEBUG_ACTIVE = True) = True And API.LoggedIn = True And Core.Player.IsGameJoltSave = True Then
            ...
            If ActionScript.IsRegistered("phone_card_radio") = True Or GameController.IS_DEBUG_ACTIVE = True Then
                FunctionList.Add("Radio")
            End If
            FunctionList.Add("Worldmap")
            If ActionScript.IsRegistered("phone_card_minimap") = True Or GameController.IS_DEBUG_ACTIVE = True Then
            ...
            If ActionScript.IsRegistered("phone_card_frontier") = True Or GameController.IS_DEBUG_ACTIVE = True Then
            ...
            Select Case EntryMode
                Case EntryModes.MainMenu
                    ...
                    Me.menuIndex = Player.Temp.LastPhonePage
        ...
        Public Overrides Sub Update()
            ...
            If Me.menuIndex <> MenuScreens.TradeRequest Then
                If KeyBoardHandler.KeyPressed(KeyBindings.SpecialKey) = True Or ControllerHandler.ButtonPressed(Buttons.Y) = True Then
                    If Me.menuIndex <> MenuScreens.UserView Then Player.Temp.LastPhonePage = Me.menuIndex
        ...
        Private Sub DrawMainMenu()
            ...
            For i = 0 To Me.FunctionList.Count - 1
                ...
                Select Case f
                    ...
                    Case "Phone"
                        t = TextureManager.GetTexture("GUI\Menus\phone", New Rectangle(96, 32, 32, 32), "")
                        displayText = "Phone"
                    Case "Radio"
                        t = TextureManager.GetTexture("GUI\Menus\phone", New Rectangle(32, 32, 32, 32), "")
                        displayText = "Radio"
                    Case "GTS"
                        t = TextureManager.GetTexture("GUI\Menus\phone", New Rectangle(64, 0, 32, 32), "")
                        displayText = "GTS"
                    Case "Frontier"
                        t = TextureManager.GetTexture("GUI\Menus\phone", New Rectangle(32, 64, 32, 32), "")
                        displayText = "Frontier"
                    Case "Worldmap"
                        t = TextureManager.GetTexture("GUI\Menus\phone", New Rectangle(64, 64, 32, 32), "")
                        displayText = "Worldmap"
                    Case "Minimap"
                        t = TextureManager.GetTexture("GUI\Menus\phone", New Rectangle(96, 64, 32, 32), "")
                        displayText = "Minimap"
                    Case "Battle Spot"
                        t = TextureManager.GetTexture("GUI\Menus\phone", New Rectangle(32, 96, 32, 32), "")
                        displayText = "BattleSpot"
                    Case "Statistics"
                        t = TextureManager.GetTexture("GUI\Menus\phone", New Rectangle(32, 0, 32, 32), "")
...
#Region "Ranklist"
        ...
        Private Sub DrawRanklist()
            ...
            If Core.Player.IsGameJoltSave = True Then
                ...
                Core.SpriteBatch.Draw(TextureManager.GetTexture("GUI\Menus\phone"), New Rectangle(CInt(startPos.X + 220), CInt(startPos.Y + 40), 16, 32), New Rectangle(96, 112, 8, 16), Color.White)
                Core.SpriteBatch.Draw(TextureManager.GetTexture("GUI\Menus\phone"), New Rectangle(CInt(startPos.X + 220 + 16), CInt(startPos.Y + 40), 304, 32), New Rectangle(102, 112, 4, 16), Color.White)
                Core.SpriteBatch.Draw(TextureManager.GetTexture("GUI\Menus\phone"), New Rectangle(CInt(startPos.X + 220 + 16 + 304), CInt(startPos.Y + 40), 16, 32), New Rectangle(104, 112, 8, 16), Color.White)
                        ...
                        For i = 0 To 8
                            ...
                            If index <= RankingList.Count - 1 Then
                                ...
                                If Not e Is Nothing Then
                                    ...
                                    Core.SpriteBatch.Draw(TextureManager.GetTexture("GUI\Menus\phone"), New Rectangle(CInt(startPos.X + 45), CInt(startPos.Y + 80 + i * 35), 16, 32), New Rectangle(96, 112, 8, 16), Color.White, 0.0F, Vector2.Zero, eff, 0.0F)
                                    Core.SpriteBatch.Draw(TextureManager.GetTexture("GUI\Menus\phone"), New Rectangle(CInt(startPos.X + 45 + 16), CInt(startPos.Y + 80 + i * 35), 478, 32), New Rectangle(102, 112, 4, 16), Color.White, 0.0F, Vector2.Zero, eff, 0.0F)
                                    Core.SpriteBatch.Draw(TextureManager.GetTexture("GUI\Menus\phone"), New Rectangle(CInt(startPos.X + 45 + 16 + 478), CInt(startPos.Y + 80 + i * 35), 16, 32), New Rectangle(104, 112, 8, 16), Color.White, 0.0F, Vector2.Zero, eff, 0.0F)
...
#Region "UserViewScreen"
        ...
        Private Sub DrawUserView()
            ...
            Core.SpriteBatch.Draw(TextureManager.GetTexture("GUI\Menus\phone"), New Rectangle(CInt(startPos.X + 45), CInt(startPos.Y + 40), 16, 32), New Rectangle(96, 112, 8, 16), Color.White)
            Core.SpriteBatch.Draw(TextureManager.GetTexture("GUI\Menus\phone"), New Rectangle(CInt(startPos.X + 45 + 16), CInt(startPos.Y + 40), 478, 32), New Rectangle(102, 112, 4, 16), Color.White)
            Core.SpriteBatch.Draw(TextureManager.GetTexture("GUI\Menus\phone"), New Rectangle(CInt(startPos.X + 45 + 16 + 478), CInt(startPos.Y + 40), 16, 32), New Rectangle(104, 112, 8, 16), Color.White)
            Core.SpriteBatch.Draw(TextureManager.GetTexture("GUI\Menus\phone"), New Rectangle(CInt(startPos.X + 45 + 16 + 200), CInt(startPos.Y + 40), 16, 32), New Rectangle(104, 112, 8, 16), Color.White)
            ...
            If UserOrigin.Contains("Server") = True Then
                Core.SpriteBatch.Draw(TextureManager.GetTexture("GUI\Menus\phone"), New Rectangle(CInt(startPos.X + 308), CInt(startPos.Y + 48), 16, 16), New Rectangle(112, 112, 16, 16), Color.White)
            End If
            ...
            For x = 0 To 4
                ...
                Select Case x
                    ...
                    Case 4
                        ...
                        End If
                End Select
                Core.SpriteBatch.Draw(TextureManager.GetTexture("GUI\Menus\phone"), New Rectangle(CInt(startPos.X + (x * 96) + 76), CInt(startPos.Y + 100), 64, 64), New Rectangle(0, 0, 32, 32), c)
                If texV <> Vector2.Zero Then
                    Core.SpriteBatch.Draw(TextureManager.GetTexture("GUI\Menus\phone"), New Rectangle(CInt(startPos.X + (x * 96) + 76), CInt(startPos.Y + 100), 64, 64), New Rectangle(CInt(texV.X), CInt(texV.Y), 32, 32), c)
                End If
                If Cursors(1) = x Then
...
#Region "Phone"
        ...
        Private Sub SelectPhoneContact()
            ...
            Player.Temp.PhonePage = Me.menuIndex
            Core.SetScreen(Me.PreScreen)
        ...
        Public Shared Sub CallID(ByVal ID As String, ByVal checkRegistered As Boolean, ByVal checkLocation As Boolean)
            ...
            Security.FileValidation.CheckFileValid(GameController.GamePath & "\Content\Data\Scripts\phone\contacts.dat", False, "PhoneScreen.vb")
            Dim contactData() As String = System.IO.File.ReadAllLines(GameController.GamePath & "\Content\Data\Scripts\phone\contacts.dat")
...
#Region "Minimap"
        ...
        Private Sub DrawMinimap()
            ...
            Core.SpriteBatch.Draw(TextureManager.GetTexture("GUI\Menus\phone"), New Rectangle(CInt(startPos.X + 365), CInt(startPos.Y + 40), 16, 32), New Rectangle(96, 112, 8, 16), Color.White)
...
#Region "Radio"
        ...
        Class RadioStation
            ...
            Public Function CanListen() As Boolean
                ...
                For Each exp As String In Me.Expansions
                    If exp.ToLower <> "radio" Then
                        If ActionScript.IsRegistered("phone_card_radio" & exp) = False Then
                            Return False
                        End If
                    End If
                Next
            ...
            Public Function GenerateText() As List(Of String)
                ...
                For Each e As String In l
                    outputList.AddRange(e.CropStringToWidth(FontManager.MainFontWhite, 400).SplitAtNewline())
                Next
        ...
        Private Sub DrawRadio()
            Dim startPos As Vector2 = GetStartPosition()
            Core.SpriteBatch.DrawString(FontManager.MainFontBlack, "Tuning: " & Me.RadioCursor.ToString(), New Vector2(startPos.X + 100, startPos.Y + 50), Color.White)
            ...
            End If
            Core.SpriteBatch.DrawString(FontManager.MainFontBlack, text1, New Vector2(startPos.X + 150 - CInt(FontManager.MainFontBlack.MeasureString(text1).X / 2), startPos.Y + 160), Color.White)
            ...
            End If
            If text2 <> "" Then
                Core.SpriteBatch.DrawString(FontManager.MainFontBlack, text2, New Vector2(startPos.X + 450 - CInt(FontManager.MainFontBlack.MeasureString(text2).X / 2), startPos.Y + 160), Color.White)
            End If
            ...
            If BroadCastLines.Count > 0 Then
                Core.SpriteBatch.DrawString(FontManager.MainFontBlack, BroadCastLines(0), New Vector2(CInt(startPos.X) + 300 - CInt(FontManager.MainFontBlack.MeasureString(BroadCastLines(0)).X / 2), CInt(startPos.Y) + 286), Color.White)
                If BroadCastLines.Count > 1 Then

                    Core.SpriteBatch.DrawString(FontManager.MainFontBlack, BroadCastLines(1), New Vector2(CInt(startPos.X) + 300 - CInt(FontManager.MainFontBlack.MeasureString(BroadCastLines(1)).X / 2), CInt(startPos.Y) + 320), Color.White)
                End If
            End If
        End Sub
        ...
        Private Sub InitializeRadio()
            ...
            Dim radioData() As String = System.IO.File.ReadAllLines(GameModeManager.GetContentFilePath("Data\System\channels.dat"))
        ...
        Public Shared Function StationCanPlay(ByVal station As RadioStation) As Boolean
            ...
            Dim file As String = GameModeManager.GetContentFilePath("Data\System\channels.dat")
            Security.FileValidation.CheckFileValid(file, False, "PhoneScreen.vb")
        ...
        Private Sub DrawTradeRequest()
            ...
            If Not TradeRequestTexture Is Nothing Then
                ...
                For i = 0 To 1
                    ...
                    Core.SpriteBatch.Draw(TextureManager.GetTexture("GUI\Menus\phone"), New Rectangle(CInt(startPos.X + 45), CInt(startPos.Y + 150 + i * 64), 16, 32), New Rectangle(96, 112, 8, 16), Color.White, 0.0F, Vector2.Zero, eff, 0.0F)
                    Core.SpriteBatch.Draw(TextureManager.GetTexture("GUI\Menus\phone"), New Rectangle(CInt(startPos.X + 45 + 16), CInt(startPos.Y + 150 + i * 64), 128, 32), New Rectangle(102, 112, 4, 16), Color.White, 0.0F, Vector2.Zero, eff, 0.0F)
                    Core.SpriteBatch.Draw(TextureManager.GetTexture("GUI\Menus\phone"), New Rectangle(CInt(startPos.X + 45 + 16 + 128), CInt(startPos.Y + 150 + i * 64), 16, 32), New Rectangle(104, 112, 8, 16), Color.White, 0.0F, Vector2.Zero, eff, 0.0F)
