Public Class NewMenuScreen
            ...
            If _gradientFade = 255 Then
                ...
                For i = 0 To _menuOptions.Count - 1
                    ...
                    If _buttonIntroFinished = True Or _buttonFadeIndex > i Then
                        ...
                        Core.SpriteBatch.DrawString(FontManager.MainFontBlack, text, New Vector2(CInt(pos.X) + 20, CInt(pos.Y) + 16), Color.White, 0.0F, Vector2.Zero, 1.25F, SpriteEffects.None, 0.0F)
                    Else
                        Dim pos = GetButtonPosition(i)
                        ...
                        Core.SpriteBatch.DrawString(FontManager.MainFontWhite, text, New Vector2(CInt(pos.X) + 20, CInt(pos.Y) + 16), New Color(0, 0, 0, _currentButtonFade), 0.0F, Vector2.Zero, 1.25F, SpriteEffects.None, 0.0F)
    ...
    Private Sub PressButton()
        Select Case _menuOptions(_menuIndex)
            ...
            Case "Pokémon"
                SetScreen(New PartyScreenV2(Me))
            Case "Bag"
