Public Class BattleGrowStatsScreen
    ...
    Public Overrides Sub Draw()
        ...
        Core.SpriteBatch.DrawString(FontManager.MiniFont, " reached level " & Pokemon.Level & "!", New Vector2(p.X + 90 + FontManager.MainFontWhite.MeasureString(Pokemon.GetDisplayName()).X, p.Y + 41), Color.Black)
