Public Class DonationScreen
    ...
    Public Overrides Sub Draw()
        ...
        Core.SpriteBatch.DrawString(FontManager.MainFontWhite, Localization.GetString("donation_donators") & ": ", New Vector2(CInt(Core.windowSize.Width / 2) - FontManager.MainFontWhite.MeasureString(Localization.GetString("donation_donators") & ": ").X / 2, 20), Color.White)
        Core.SpriteBatch.DrawString(FontManager.MainFontWhite, Localization.GetString("donation_close"), New Vector2(CInt(Core.windowSize.Width / 2) - FontManager.MainFontWhite.MeasureString(Localization.GetString("donation_close")).X / 2, 640), Color.White)
    End Sub
