Public Class OfflineGameWarningScreen
    ...
    Public Overrides Sub Draw()
        ...
        Core.SpriteBatch.DrawString(FontManager.MainFontWhite, Localization.GetString("offline_newgame_start", "Start a new offline game."), New Vector2(CSng(Core.windowSize.Width / 2 - 280), 130), Color.White)
        ...
        Core.SpriteBatch.DrawString(FontManager.MainFontWhite, t, New Vector2(CSng(Core.windowSize.Width / 2 - 310) + 50, 240), Color.White)
