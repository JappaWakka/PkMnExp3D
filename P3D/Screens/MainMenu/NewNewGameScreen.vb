    ...
    Public Class NewNewGameScreen
        ...
        Public Class CharacterSelectionScreen
            ...
            Public Overrides Sub Draw()
                ...
                SpriteBatch.DrawString(FontManager.MainFontWhite, Localization.GetString("new_game_select_skin"), New Vector2(windowSize.Width / 2.0F - FontManager.MainFontWhite.MeasureString(Localization.GetString("new_game_select_skin")).X, 100), New Color(255, 255, 255, CInt(255 * _fadeIn)), 0F, Vector2.Zero, 2.0F, SpriteEffects.None, 0F)
                ...
                SpriteBatch.DrawString(FontManager.MainFontWhite, _names(_index), New Vector2(CInt(windowSize.Width / 2.0F - FontManager.MainFontWhite.MeasureString(_names(_index)).X), CInt(windowSize.Height / 2.0F + 200)), New Color(255, 255, 255, CInt(255 * _fadeIn)), 0F, Vector2.Zero, 2.0F, SpriteEffects.None, 0F)
                SpriteBatch.DrawString(FontManager.MainFontWhite, _genders(_index), New Vector2(CInt(windowSize.Width / 2.0F - FontManager.MainFontWhite.MeasureString(_genders(_index)).X / 2.0F), CInt(windowSize.Height / 2.0F + 300)), New Color(255, 255, 255, CInt(255 * _fadeIn)), 0F, Vector2.Zero, 1.0F, SpriteEffects.None, 0F)
            End Sub
