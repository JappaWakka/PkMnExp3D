...
Public Class PartyScreenV2
    ...
    Private Sub DrawBackground()
        ...
        SpriteBatch.DrawString(FontManager.MainFontWhite, POKEMON_TITLE, New Vector2(halfWidth - 390, halfHeight - 228), mainBackgroundColor)
    ...
    Private Sub DrawPokemon(ByVal index As Integer)
        ...
        If p.IsEgg() Then
            ...
            'name:
            GetFontRenderer().DrawString(FontManager.MainFontWhite, p.GetDisplayName(), New Vector2(position.X + 156, position.Y + 27), New Color(255, 255, 255, CInt(255 * _interfaceFade)))
        Else
            ...
            'name:
            GetFontRenderer().DrawString(FontManager.MainFontWhite, p.GetDisplayName(), New Vector2(position.X + 78, position.Y + 5), New Color(255, 255, 255, CInt(255 * _interfaceFade)))

            'Gender symbol:
            Select Case p.Gender
                Case Pokemon.Genders.Male
                    SpriteBatch.Draw(_menuTexture, New Rectangle(CInt(position.X + FontManager.MainFontWhite.MeasureString(p.GetDisplayName()).X + 86), CInt(position.Y + 9), 7, 13), New Rectangle(25, 0, 7, 13), New Color(255, 255, 255, CInt(255 * _interfaceFade)))
                Case Pokemon.Genders.Female
                    SpriteBatch.Draw(_menuTexture, New Rectangle(CInt(position.X + FontManager.MainFontWhite.MeasureString(p.GetDisplayName()).X + 85), CInt(position.Y + 9), 9, 13), New Rectangle(32, 0, 9, 13), New Color(255, 255, 255, CInt(255 * _interfaceFade)))
            End Select

            'Level:
            GetFontRenderer().DrawString(FontManager.MainFontWhite, "Lv. " & p.Level.ToString(), New Vector2(position.X + 4, position.Y + 56), New Color(255, 255, 255, CInt(255 * _interfaceFade)))
            ...
            'HP display:
            GetFontRenderer().DrawString(FontManager.MainFontWhite, p.HP & " / " & p.MaxHP, New Vector2(position.X + 100, position.Y + 50), New Color(255, 255, 255, CInt(255 * _interfaceFade)))
            ...
            If LearnType > 0 Then
                ...
                End Select
            End If
            GetFontRenderer().DrawString(FontManager.MainFontWhite, AttackLabel, New Vector2(position.X + 210, position.Y + 50), New Color(255, 255, 255, CInt(255 * _interfaceFade)))
    ...
    Private Sub UseFlash()
        ...
        If Screen.Level.IsDark = True Then
            Dim s As String = "version=2" & Environment.NewLine &
                              ...
                              "@sound.play(Battle\Attacks\Thunderbolt)" & Environment.NewLine &
