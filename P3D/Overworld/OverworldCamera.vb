            ...
            If OS.ActionScript.IsReady = True Then
                If (KeyBoardHandler.KeyPressed(KeyBindings.CameraLockKey) = True Or ControllerHandler.ButtonPressed(Buttons.RightStick)) = True And _moved = 0.0F And YawLocked = False Then
                    ...
                    If _freeCameraMode = False Then
                        Core.GameMessage.ShowMessage(Localization.GetString("game_message_free_camera") & ": " & Localization.GetString("global_off"), 12, FontManager.MainFontWhite, Color.White)
                    Else
                        Core.GameMessage.ShowMessage(Localization.GetString("game_message_free_camera") & ": " & Localization.GetString("global_on"), 12, FontManager.MainFontWhite, Color.White)
                    End If
                End If
            End If
        End If
        ...
        If _thirdPerson <> isThirdPerson Then
            ...
            If _thirdPerson = True Then
                ...
                If showMessage = True Then
                    Core.GameMessage.ShowMessage(Localization.GetString("game_message_third_person") & ": " & Localization.GetString("global_on"), 12, FontManager.MainFontWhite, Color.White)
                End If
            Else
                Yaw = GetAimYawFromDirection(GetFacingDirection())
                If showMessage = True Then
                    Core.GameMessage.ShowMessage(Localization.GetString("game_message_third_person") & ": " & Localization.GetString("global_off"), 12, FontManager.MainFontWhite, Color.White)
                End If
            End If
        End If
    End Sub
