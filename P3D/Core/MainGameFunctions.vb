Public Class MainGameFunctions
    ...
    Public Shared Sub FunctionKeys()
        ...
        ElseIf KeyBoardHandler.KeyPressed(KeyBindings.LightKey) Then
            ...
            If Core.GameOptions.LightingEnabled Then
                Core.GameMessage.ShowMessage(Localization.GetString("game_message_lighting") & ": " & Localization.GetString("global_on"), 12, FontManager.MainFontWhite, Color.White)
            Else
                Core.GameMessage.ShowMessage(Localization.GetString("game_message_lighting") & ": " & Localization.GetString("global_off"), 12, FontManager.MainFontWhite, Color.White)
            End If
        ...
        If KeyBoardHandler.KeyDown(KeyBindings.DebugKey) = True Then
            If KeyBoardHandler.KeyPressed(Keys.F) Then
                ...
                Core.GameMessage.ShowMessage("Texture list has been cleared", 12, FontManager.MainFontWhite, Color.White)
        ...
        If ControllerHandler.ButtonPressed(Buttons.Back, True) = True Then
            ...
            If Core.GameOptions.GamePadEnabled Then
                Core.GameMessage.ShowMessage(Localization.GetString("game_message_xbox_controller") & ": " & Localization.GetString("global_enabled"), 12, FontManager.MainFontWhite, Color.White)
            Else
                Core.GameMessage.ShowMessage(Localization.GetString("game_message_xbox_controller") & ": " & Localization.GetString("global_disabled"), 12, FontManager.MainFontWhite, Color.White)
            End If
            Core.GameOptions.SaveOptions()
        End If
    End Sub
    ...
    Private Shared Sub ToggleFullScreen()
        If Core.GraphicsManager.IsFullScreen = False Then
            ...
            Core.GameMessage.ShowMessage(Localization.GetString("game_message_fullscreen") & ": " & Localization.GetString("global_on"), 12, FontManager.MainFontWhite, Color.White)
        Else
            ...
            Core.GameMessage.ShowMessage(Localization.GetString("game_message_fullscreen") & ": " & Localization.GetString("global_off"), 12, FontManager.MainFontWhite, Color.White)
        End If
