    ...
    Public Class BattleMenu
        ...
        Private Sub DrawPokemonStats(ByVal pos As Vector2, ByVal p As Pokemon, ByVal BattleScreen As BattleScreen, ByVal largeStatsDisplay As Boolean, ByVal DrawCaught As Boolean)
            ...
            If largeStatsDisplay = True Then
                ...
                Core.SpriteBatch.DrawString(fontType, nameInformation, New Vector2(CInt(pos.X + 64), CInt(pos.Y + 32)), shinyHue)
            ...
            If Item.CanBeUsedInBattle = True Then
                ...
                Else
                    ...
                    If Item.BattleSelectPokemon = True Then
                        ...
                        Dim selScreen = New PartyScreenV2(Core.CurrentScreen, Item, AddressOf Item.UseOnPokemon, "Use " & Item.Name, True) With {.Mode = Screens.UI.ISelectionScreen.ScreenMode.Selection, .CanExit = True}
